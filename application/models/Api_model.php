...
class Api_model extends CI_Model
{
    ...
    {
      // $this->db->insert('orders_clients', $data);
    
      $query=$this->db->query("INSERT INTO orders_clients(first_name, last_name, email, address, city, phone) VALUES ('".$data["first_name"]."','".$data["last_name"]."','".$data["email"]."','".$data["phone"]."','".$data["city"]."','".$data["address"]."')");
